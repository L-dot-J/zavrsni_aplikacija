...
// Tailwind-based block types for content rendering
// 'callout', 'heading', 'list', 'fact', 'image', 'image_small', 'unity', 'q&a', 'paragraph'
export const cardsData = [
  // 1. Uvod u mehaniku fluida
  {
    id: 1,
  ...
  // 2. Osnovna svojstva fluida
  // ...existing code for card 2...
  // 3. Uvod u statika fluida
  {
    id: 3,
    ...
    content: [
      ...
      { type: 'fact', value: 'Kada je fluid u mirovanju, jedine sile koje djeluju su gravitacija i unutarnji tlak. S dubinom u fluidu povećava se tlak jer svaki sloj fluida „nosi“ težinu slojeva iznad sebe.' },
      ...
      { type: 'heading', value: 'Stvarni primjeri primjene' },
      { type: 'list', value: [
        'Prilikom ronjenja, ronioci osjećaju sve veći tlak na uši i pluća kako se spuštaju – to je rezultat rasta hidrostatskog tlaka.',
        ...
        'U meteorologiji, razlike u atmosferskom tlaku određuju smjer i brzinu vjetrova – viši tlak „gura“ zrak prema nižem.'
      ] },
  ...
  // 4. Pascalov zakon
  {
    ...
    content: [
      { type: 'q&a', value: '❓ Kako Pascalov zakon omogućuje podizanje auta pomoću dizalice?' },
      { type: 'q&a', value: '❓ Zašto su kočnice u automobilima učinkovitije s hidrauličkim sustavom?' },
      { type: 'callout', value: 'Kada nanesete tlak u jednoj točci probajte pogoditi koliki je u drugoj! Desnim klikom miša nanesite početni tlak a lijevim saznajte tlak u odabranoj točci.' },
      ...
      { type: 'paragraph', value: 'U primjeru, u svakom od tri slučaja guramo lijevo cilindar površine A_1 prema dolje, stvaramo tlak u vodi koji gura desne cilindre (A_1, A_2, A_3) prema gore. Pomak desnih cilindara obrnuto je proporcionalan njihovoj površini. Ako na svaki lijevi cilindar djelujemo istom silom, sile na desnim cilindrima bit će proporcionalne površini presjeka desnog cilindra.' },
      ...
      { type: 'image', value: hidraulic, alt: 'prikaz pascalovog zakona' },
      { type: 'heading', value: 'Stvarni primjeri primjene' },
      { type: 'list', value: [
        'Hidraulička dizalica u autoservisu: Mehaničar koristi malu silu na ručici, a dizalica podiže cijeli automobil zahvaljujući prijenosu tlaka.',
        ...
        'Hidraulična preša: Koristi se u industriji za oblikovanje metala, rezanje ili sabijanje materijala.',
      ...
      { type: 'q&a', value: '✅ Pascalov zakon kaže da se povećanje tlaka u zatvorenom fluidu prenosi jednako u svim smjerovima. U hidrauličkoj dizalici, mala sila na manji klip prenosi se kao veliki tlak na veći klip, što omogućuje podizanje teškog automobila s malim naporom.' },
      { type: 'q&a', value: '✅ Zato što se pomoću Pascalovog zakona pritisak iz papučice prenosi kroz tekućinu ravnomjerno na sve kočne cilindre, što omogućuje ravnomjerno i snažno kočenje svih kotača bez dodatne sile.' },
    ]
  },
  // 5. Arhimedov zakon
  {
    ...
    content: [
      { type: 'q&a', value: '❓ Zašto brod od čelika ne tone iako je čelik gušći od vode?' },
      { type: 'q&a', value: '❓ Možemo li otkriti lažni zlatnik pomoću Arhimedovog zakona?' },
      { type: 'unity', build: 'Build3' },
      { type: 'heading', value: 'Arhimedov zakon' },
      { type: 'paragraph', value: 'Arhimedov zakon jedan je od temeljnih zakona hidrostatike, a formulirao ga je grčki matematičar i izumitelj Arhimed još u 3. stoljeću prije nove ere. Zakon glasi: “Na svako tijelo uronjeno u fluid djeluje uzgon jednak težini istisnutog fluida.” Fluid "gura" tijelo prema gore silom koja ovisi o količini istisnutog fluida.' },
      { type: 'image_small', value: Arhimed, alt: 'prikaz Arhimedovog zakona' },
      { type: 'paragraph', value: 'Ova sila uzgona je razlog zašto brodovi ne tonu i zašto se osjećamo lakšima kad smo uronjeni u vodu. Arhimed je navodno otkrio zakon dok se kupao u kadi i primijetio da se voda prelijeva – što ga je dovelo do spoznaje da količina istisnute vode odgovara volumenu njegovog tijela.' },
      { type: 'heading', value: 'Ključni pojmovi' },
      { type: 'list', value: [
      ...
      { type: 'list', value: [
        ...
        'Plivanje: Ljudsko tijelo istiskuje određeni volumen vode. Ako je gustoća tijela manja od vode, tijelo će plutati.',
      ...
      { type: 'q&a', value: '✅ Zato što brod ima velik volumen i istiskuje puno vode. Ukupna gustoća broda (uključujući zrak unutar njega) je manja od gustoće vode, pa prema Arhimedovom zakonu uzgon nadjača težinu i brod pluta.' },
      { type: 'q&a', value: '✅ Da! Ako zlatnik nije od čistog zlata, imat će drugačiju gustoću. Vagajući ga u zraku i vodi, možemo izračunati njegov volumen i gustoću. Ako se ne podudara s gustoćom zlata (19.3 g/cm³), radi se o prijevari.' },
    ]
  },
  // // ...existing code for other cards...
  {
    ...
    content: [
      { type: 'q&a', value: '❓ 1.Zašto tekućina "traži" svoj oblik u svakoj posudi u koju je ulijemo?' },
      { type: 'q&a', value: '❓ 2.Zašto tekućina "traži" svoj oblik u svakoj posudi u koju je ulijemo?' },
      ...
      { type: 'fact', value: 'Kretanje žlice: Pomičite žlicu desnim klikom miša kako bi sakupili molekule fluida.' },
      { type: 'fact', value: 'Interakcija s molekulama: Pomičite žlicu kroz fluid da vidite kako se lagano pomiču pod silom, primijetite da su nestlačive.' },
      { type: 'fact', value: 'Oblikovanje fluida: Lijevim klikom miša crtajte proizvoljne oblike koje će molekule popuniti - fluidi nemaju vlastiti oblik!' },
      ...
      { type: 'fact', value: 'Podešavanje gustoće: Povlačenjem klizača mijenjajte gustoću lignje i okolnog fluida.' },
      { type: 'fact', value: 'Ovisno o omjeru gustoća, lignja će: potonuti ako je gušća od fluida, stajati na mjestu ako je pri neutralnoj gustoći, isploviti ako je rjeđa od fluida.' },
      ...
      { type: 'q&a', value: '✅ 1.Zato što fluidi nemaju vlastiti oblik, oni preuzimaju oblik posude zbog toga što čestice fluida mogu slobodno kliziti jedna preko druge. To je jedno od osnovnih svojstava fluida: tekućnost i prilagodljivost obliku.' },
      { type: 'q&a', value: '✅ 2.Med ima veću viskoznost od vode, što znači da su sile unutarnjeg trenja među česticama veće. Viskoznost je jedno od osnovnih svojstava fluida i pokazuje koliko lako (ili teško) tekućina teče.' },
    ]
  },
  // {
  //   id: 3,
  ...
  //   description: 'Opći pojmovi statike fluida i kako se primjenjuje u praksi.',
  //   content: [
  //       { type: 'text', value: 'Statika fluida je dio mehanike fluida koji proučava fluide u mirovanju. To znači da se ne uzima u obzir gibanje fluida, već samo sile koje djeluju dok je fluid u stanju ravnoteže. Ključni pojam u statici fluida je tlak, koji se prenosi u svim smjerovima jednako i djeluje okomito na sve površine u kontaktu s fluidom.' },
  //       { type: 'image', value: staticwater, alt: 'prikaz fluida u mirovanju' },
  //       { type: 'text', value: 'Kada je fluid u mirovanju, jedine sile koje djeluju su gravitacija i unutarnji tlak. Važno je razumjeti da se s dubinom u fluidu povećava tlak jer svaki sloj fluida „nosi“ težinu slojeva iznad sebe. Upravo zbog toga ronjenje na većim dubinama zahtijeva posebnu opremu koja može izdržati veće tlakove.' },
  //       { type: 'text', value: '## Ključni pojmovi u statici fluida' },
  //       { type: 'text', value: '- Tlak (p): sila po jedinici površine. Jedinica je Pascal (Pa).\n- Hidrostatski tlak: tlak uzrokovan težinom fluida iznad točke mjerenja. Računa se po formuli p = ρgh.\n- Površinski tlak: tlak koji djeluje na površinu fluida, npr. atmosferski tlak.\n- Otvoreni i zatvoreni sustavi: otvoreni su pod utjecajem atmosferskog tlaka, dok zatvoreni imaju vlastiti unutarnji tlak.' },
  //       { type: 'text', value: '## Važnost statike fluida u praksi' },
  //       { type: 'text', value: 'Razumijevanje ravnoteže i djelovanja tlaka u fluidima omogućuje dizajn sigurnih sustava – od rezervoara za vodu, preko brana, do ronilačke opreme. Također je važno kod određivanja koliki pritisak krv vrši na stijenke krvnih žila u medicinskim primjenama.' },
  //       { type: 'image_small', value: pressure, alt: 'prikaz fluida u mirovanju' },
  //       { type: 'text', value: '## Stvarni primjeri primjene' },
  //       { type: 'text', value: '- Prilikom ronjenja, ronioci osjećaju sve veći tlak na uši i pluća kako se spuštaju – to je rezultat rasta hidrostatskog tlaka.\n- Proračun visine vodenog stupa u vodoopskrbnim sustavima koristi formulu za hidrostatski tlak kako bi se osigurao dovoljan tlak u slavini.\n- U dizajnu brana mora se pažljivo proračunati raspodjela tlaka duž površine brane kako bi se spriječilo pucanje.\n- Prilikom gradnje akvarija ili spremnika za tekućine, debljina stakla mora biti usklađena s količinom tlaka koji će djelovati na stijenke.\n- U meteorologiji, razlike u atmosferskom tlaku određuju smjer i brzinu vjetrova – viši tlak „gura“ zrak prema nižem.' },
  //       { type: 'text', value: '<div style="background:#18181b;border-left:5px solid #f2be90;padding:16px 20px;border-radius:12px;margin:18px 0;font-size:1.05em;">'
  // + '<strong>ZANIMLJIVOST:</strong> Posuda VS. jezero<br><br>'
  // + ' Tlak koji vrši statička tekućina ovisi samo o dubini, gustoći i gravitaciji, a ne o ukupnoj masi ili volumenu tekućine. To znači da će mala posuda s vodom na određenoj dubini vršiti isti tlak kao i ogromno jezero na istoj dubini, sve dok su gustoće iste.'
  //  },
  ...
  //     { type: 'q&a', value: '❓ Kako Pascalov zakon omogućuje podizanje auta pomoću dizalice?' },
  //     { type: 'q&a', value: '❓ Zašto su kočnice u automobilima učinkovitije s hidrauličkim sustavom?' },
  //     { type: 'text', value: '🔹 <em style=" color: #f2be90; font-size: 0.8em; font-style: italic;">Kada nanesete tlak u jednoj točci probajte pogoditi koliki je u drugoj!</em> ' },
  //     { type: 'text', value: '🔹 <em style="color: #f2be90; font-size: 0.8em; font-style: italic;">Desnim klikom miša nanesite početni tlak a lijevim saznajte tlak u odabranoj točci</em>' },
  //     { type: 'unity', build: 'Build2' },
  //     { type: 'text', value: 'Pascalov zakon jedan je od temeljnih zakona statike fluida. Formulirao ga je francuski matematičar i fizičar Blaise Pascal, a zakon glasi: “Tlak koji se primjenjuje na zatvoreni fluid prenosi se ravnomjerno u svim smjerovima.” Drugim riječima, ako pritisnemo fluid unutar zatvorenog sustava, taj pritisak će se prenijeti jednako na sve dijelove sustava i djelovat će okomito na sve stijenke.' },
  //     { type: 'image_small', value: pascalimage, alt: 'prikaz Pascalovog zakona' },
  //     { type: 'text', value: '<div style="background:#18181b;border-left:5px solid #f2be90;padding:16px 20px;border-radius:12px;margin:18px 0;font-size:1.05em;">'
  // + '<strong>ZANIMLJIVOST:</strong> Raznolikost Pascala<br><br>'
  // + ' Zanimljiva činjenica o Blaiseu Pascalu je da je, osim svojih matematičkih i znanstvenih postignuća, izumio jedan od prvih mehaničkih kalkulatora, nazvan Pascaline, kako bi pomogao ocu u izračunima poreza. Ovaj izum bio je značajan korak prema razvoju modernog računarstva.'
  //  },
      
  //     { type: 'text', value: '## Ključni pojmovi' },
  //     { type: 'text', value: '- Zatvoreni sustav: fluid se nalazi unutar sustava gdje ne može slobodno istjecati, npr. cilindar s klipovima.\n- Hidraulička sila: rezultat primjene Pascalovog zakona; mala početna sila može uzrokovati veću izlaznu silu.\n- Površina i tlak: Ako se na manju površinu primijeni tlak, on se ravnomjerno prenosi na veću površinu uz veću silu (F = p × A).' },
  //     { type: 'image', value: pascalgif, alt: 'prikaz Pascalovog zakona', style:"background:#98181b;" },
  //     { type: 'text', value: 'U gore navednom primjeru, u svakom od tri slučaja guramo lijevo cilindar površine A_1 prema dolje, time stvaramo tlak u vodi koji gura desne cilindre koji imaju površine A_1, A_2 i A_3 prema gore. Pomak za koji se desni cilindri odmaknu obrnuto je proporcionalan njihovoj površini. Ako na svaki lijevi cilindar djelujemo istom silom sile na desnim cilindrima će biti F_1 > F_2 > F_3 tj. bit će proporcionalne površini presjeka desnog cilindra.' },
  //     { type: 'text', value: '## Praktična primjena Pascalovog zakona' },
  //     { type: 'text', value: 'Zahvaljujući ovom zakonu razvijeni su sustavi koji omogućuju podizanje, guranje ili stiskanje velikih tereta pomoću male ulazne sile. Primjene sežu od medicinskih instrumenata, preko automobilskih sustava, pa sve do industrijskih strojeva.' },
  //      { type: 'image', value: hidraulic, alt: 'prikaz pascalovog zakona' },
  //     { type: 'text', value: '## Stvarni primjeri primjene' },
  //     { type: 'text', value: '- Hidraulička dizalica u autoservisu: Mehaničar koristi malu silu na ručici, a dizalica podiže cijeli automobil zahvaljujući prijenosu tlaka.\n- Kočioni sustavi u vozilima: Kada vozač pritisne kočnicu, tlak se prenosi kroz kočionu tekućinu do svih kotača, omogućujući ravnomjerno kočenje.\n- Hidraulična preša: Koristi se u industriji za oblikovanje metala, rezanje ili sabijanje materijala.\n- Stomatološke stolice: Podešavanje visine i nagiba koristi Pascalov princip za precizno podizanje i spuštanje stolice.\n- Ambulantna nosila s hidrauličnim sustavom: Medicinsko osoblje može podignuti pacijenta pomoću malih pokreta jer sustav koristi prijenos tlaka da olakša rad.' },
  //     { type: 'q&a', value: '✅ 1.Pascalov zakon kaže da se povećanje tlaka u zatvorenom fluidu prenosi jednako u svim smjerovima. U hidrauličkoj dizalici, mala sila na manji klip prenosi se kao veliki tlak na veći klip, što omogućuje podizanje teškog automobila s malim naporom.' },
  //     { type: 'q&a', value: '✅ 2.Zato što se pomoću Pascalovog zakona pritisak iz papučice prenosi kroz tekućinu ravnomjerno na sve kočne cilindre, što omogućuje ravnomjerno i snažno kočenje svih kotača bez dodatne sile.' },
  ...
  //     { type: 'q&a', value: '❓ Možemo li otkriti lažni zlatnik pomoću Arhimedovog zakona?' },
  //     { type: 'unity', build: 'Build3' },
  //      { type: 'text', value: 'Arhimedov zakon jedan je od temeljnih zakona hidrostatike, a formulirao ga je grčki matematičar i izumitelj Arhimed još u 3. stoljeću prije nove ere. Zakon glasi: “Na svako tijelo uronjeno u fluid djeluje uzgon jednak težini istisnutog fluida.” Drugim riječima, fluid "gura" tijelo prema gore silom koja ovisi o količini istisnutog fluida.' },
  //     { type: 'image_small', value: Arhimed, alt: 'prikaz Arhimedovog zakona' },
  //     { type: 'text', value: 'Ova sila uzgona je razlog zašto brodovi ne tonu i zašto se osjećamo lakšima kad smo uronjeni u vodu. Arhimed je navodno otkrio zakon dok se kupao u kadi i primijetio da se voda prelijeva – što ga je dovelo do spoznaje da količina istisnute vode odgovara volumenu njegovog tijela.' },
  //     { type: 'text', value: '## Ključni pojmovi' },
  //     { type: 'text', value: '- Uzgon: Sila koja djeluje suprotno od gravitacije na tijelo uronjeno u fluid.\n- Istisnuti volumen: Dio fluida koji tijelo "gura" dok se nalazi uronjeno u njega.\n- Gustoća fluida: Što je veća gustoća fluida, to je uzgon veći za isti volumen.\n- Plovnost: Sposobnost tijela da pluta u fluidu, ovisno o odnosu gustoće tijela i fluida.' },
  //     { type: 'text', value: '## Matematički izraz' },
  //     { type: 'text', value: '- Uzgon (F) = ρ × V × g\n\n- ρ: gustoća fluida (kg/m³)\n- V: volumen istisnutog fluida (m³)\n- g: gravitacijsko ubrzanje (9.81 m/s²)' },
  //     { type: 'text', value: '## Praktična primjena Arhimedovog zakona' },
  //     { type: 'text', value: 'Zakon se koristi za dizajn brodova, podmornica, mjerenje gustoće nepoznatih materijala i razumijevanje plovnosti tijela. Inženjeri, fizičari i znanstvenici oslanjaju se na Arhimedov zakon pri izradi mnogih uređaja i konstrukcija koje dolaze u dodir s fluidima.' },
  //     { type: 'image_small', value: arhimedsile, alt: 'prikaz Arhimedovog zakona' },
  //     { type: 'text', value: 'U gore navednom primjeru, prikazuju se sile koje djeluju na kocku potpuno uronjenu u tekućinu, što je temelj za razumijevanje Arhimedovog zakona i sile uzgona. Na kocku djeluju horizontalne sile (R_left i R_right) koje se međusobno poništavaju jer su jednake veličine. Vertikalno, na gornju stranu djeluje sila R_top, a na donju R_bottom – budući da je dno dublje, R_bottom je veća. Ta razlika stvara rezultantnu silu prema gore, odnosno uzgon. Uz to, na kocku djeluje i sila težine (W) prema dolje. Ako je uzgon veći od težine, tijelo će isplivati; ako je manji, potonut će; a ako su jednaki, kocka će mirno lebdjeti u fluidu.' },
  //      { type: 'text', value: '<div style="background:#18181b;border-left:5px solid #f2be90;padding:16px 20px;border-radius:12px;margin:18px 0;font-size:1.05em;">'
  // + '<strong>ZANIMLJIVOST:</strong> <br><br>'
  // + 'Otkriće zakona potencijalno se dogodilo tijekom Arhimedove kupke, a princip se koristi i za otkrivanje prijevare (provjera autentičnosti zlatnika, nakita i dragulja) te za izračunavanje volumena objekta koji nema pravilan oblik.'
  //  },
  //     { type: 'text', value: '## Stvarni primjeri primjene' },
  //     { type: 'text', value: '- Brodovi i tankeri: Iako su građeni od metala, oblik broda omogućuje istiskivanje velike količine vode pa uzgon nadmašuje težinu – brod pluta.\n- Plivanje: Ljudsko tijelo istiskuje određeni volumen vode. Ako je gustoća tijela manja od vode, tijelo će plutati.\n- Podmornice: Pomoću balastnih spremnika podmornica regulira količinu vode u sebi i tako upravlja dubinom uranjanja.\n- Zračni baloni: Umjesto vode, baloni istiskuju zrak. Helij ili vrući zrak imaju manju gustoću, pa balon uzlazi.\n- Mjerenje gustoće krune (legendarni primjer): Arhimed je pomoću zakona dokazao da kruna nije izrađena od čistog zlata – mjereći količinu istisnute vode i uspoređujući s masom krune.' },
  //     { type: 'q&a', value: '✅ 1.Zato što brod ima velik volumen i istiskuje puno vode. Ukupna gustoća broda (uključujući zrak unutar njega) je manja od gustoće vode, pa prema Arhimedovom zakonu uzgon nadjača težinu i brod pluta.' },
  //     { type: 'q&a', value: '✅ 2.Da! Ako zlatnik nije od čistog zlata, imat će drugačiju gustoću. Vagajući ga u zraku i vodi, možemo izračunati njegov volumen i gustoću. Ako se ne podudara s gustoćom zlata (19.3 g/cm³), radi se o prijevari.' },
